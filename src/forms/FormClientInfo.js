...
const FormValidations = {
    ...
    income: { required: true, number: true, type: "number", },
...
const FormClientInfo = ({ onSubmit, form, id, collections }) => {
    ...
    return (
        <form id={id} className="form" onSubmit={onSubmit}>
            ...
            <div className="label-outer label-above">
                8. მიუთითე შენი ფაქტიური მისამართი
            </div>
            ...
            <div className="row">
                <div className="col">
                    <FormSelect
                        ...
                        form={form}
                        floatLabel={false}
                        label="9. მოსალოდნელი წლიური ბრუნვა"
            ...
            <div className="row">
                <div className="col">
                    <FormSelect
                        ...
                        form={form}
                        floatLabel={false}
                        label="11. მოსალოდნელი ოპერაციები"
            ...
            <div className="row">
                <div className="col">
                    <FormSelect
                        ...
                        form={form}
                        floatLabel={false}
                        label="13. ანგარიშის გახსნის მიზნობრიობა"
...
export default VtbForm(FormClientInfo, FormValues, FormValidations);