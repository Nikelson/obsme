    ...
    return (
        <form id={id} className="form" onSubmit={onSubmit} style={{ maxWidth: "450px" }}>
            ...
            <div className="row radios-right">
                <div className="col checkbox-label">
                    <span className="label-outer">
                        2. ხარ თუ არა პოლიტიკურად აქტიური პირი, ან პოლიტიკურად აქტიური პირის ოჯახის წევრი (მეუღლე, და, ძმა, მშობელი, შვილი/გერი და მისი მეუღლე) ან ფიზიკური პირი, რომელსაც პოლიტიკურად აქტიურ პირთან აქვს მჭიდრო საქმიანი ურთიერთობა?
                    </span>
                </div>
                <div className="col radio-cols">
                    <div className="row">
            ...
            <div className="row radios-right">
                <div className="col checkbox-label">
                    <span className="label-outer">
                        3. ხარ თუ არა ამერიკის მოქალაქე?
                    </span>
                </div>
                <div className="col radio-cols">
                    <div className="row">
                        <div className="col">
                            <RadioButton checked={isRadioChecked("usCitizen", 1)} value="1" onChange={form.updateInput} name="usCitizen">კი</RadioButton>
                        </div>
                        <div className="col">
                            <RadioButton checked={isRadioChecked("usCitizen", 0)} value="0" onChange={form.updateInput} name="usCitizen">არა</RadioButton>
                        </div>
                    </div>
                </div>
                {!form.state.usCitizen.isValid &&
                    <div className="col validation">
                        <FormValidationMessage isValid={false} for={form.state.usCitizen} />
                    </div>
                }
            </div>
            <div className="row radios-right">
                <div className="col checkbox-label">
                    <span className="label-outer">
                        4. ხარ თუ არა აშშ-ს საგადასახდო რეზიდენტი?
                    </span>
                </div>
                <div className="col radio-cols">
                    <div className="row">
            ...
            <div className="row radios-right">
                <div className="col checkbox-label">
                    <span className="label-outer">
                        5. ფლობ თუ არა მწვანე ბარათს?
                    </span>
                </div>
                <div className="col radio-cols">
                    <div className="row">
                        <div className="col">
                            <RadioButton checked={isRadioChecked("usGreenCard", 1)} value="1" onChange={form.updateInput} name="usGreenCard">კი</RadioButton>
                        </div>
                        <div className="col">
                            <RadioButton checked={isRadioChecked("usGreenCard", 0)} value="0" onChange={form.updateInput} name="usGreenCard">არა</RadioButton>
                        </div>
                    </div>
                </div>
                {!form.state.usGreenCard.isValid &&
                    <div className="col validation">
                        <FormValidationMessage isValid={false} for={form.state.usGreenCard} />
                    </div>
                }
            </div>
            <div className="row radios-right">
                <div className="col checkbox-label">
                    <span className="label-outer">
                        6. არის თუ არა საქმიანობის სფერო დაკავშირებული კრიპტო აქტივებთან, ფორექსთან, აზარტულ თამაშობებთან, თავისუფალ ინდუსტრიულ ზონებთან, სადაზღვევო და საინვესტიციო საქმიანობასთან
                    </span>
                </div>
                <div className="col radio-cols">
                    <div className="row">
            ...
            <div className="row">
                <div className="col">
                    <FormInput
                        ...
                        name="email"
                        form={form}
                        label="7. მიუთითე ელ. ფოსტის მისამართი"
                    />
                </div>
            </div>
        </form>
